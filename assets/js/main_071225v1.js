// ============================================
// MAIN.JS - FINAL VERSION (NO ACCENTS IN COMMENTS)
// ============================================
...
async function initApp() {
    ...
    try {
        ...
        const discountValidator = await import('./cart/discountValidator.js');
        ...
        // Load modal system
        // -------------------------------------
        console.log("Load modal modules");
        await import('./modals/modalProduct.js');
        await import('./modals/modalFabrication.js');
