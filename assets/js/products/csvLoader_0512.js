...
function generateCloudinaryImage(reference) {
    if (!reference) return CONFIG.placeholder;

    const cleanRef = reference.trim();  // On garde la casse EXACTE

    return `https://res.cloudinary.com/dcak9pjrt/image/upload/v1761920568/${cleanRef}`;
}
